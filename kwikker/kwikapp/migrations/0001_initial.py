# Generated by Django 4.0.2 on 2022-06-04 12:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kwik', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='KwikToLike', to='kwikapp.kwik')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserWhoLike', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='CommentKwik',
